...
//cambiata condizione while
        ...
        System.out.println("  perc abandons centralino..=   " + (abandon/(index+abandon)));
        double div = abandon/(index+abandon);
        System.out.println(index+abandon + " " + div);
