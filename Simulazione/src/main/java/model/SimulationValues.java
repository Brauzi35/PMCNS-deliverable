...
public final class SimulationValues {
    ...
    public static final double STOP    = 55800.0;        /* terminal (close the door) time */ //dalle 7 alle 24 in sec 61200.0; 55800 tolte 3 fasce
    public static final int    SERVERS = 70;              /* number of servers              */
    public static final int    SERVERS_REMOTI = 70;
    public static final int    SERVERS_FIELD_STD = 60;
    public static final int    SERVERS_FIELD_SPECIAL = 17;
